...
def get_model_answers(
    ...
    import re
    if re.search("6.*9|12b",model_path):
    ...
    questions = []
    with open(
            "/private/home/liudianqing/projects/direct-preference-optimization-main/data/PKU-SafeRLHF-test.json") as fr:
        i = 0
        lines = json.load(fr)
        for line in lines:
            if i not in ids:
            ...
            prompt = line
            questions[-1]["turns"].append(prompt)
