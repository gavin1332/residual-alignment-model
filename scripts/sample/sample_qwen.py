...
if __name__ == '__main__':
    ...
    model_name_or_path = "/private/home/liuyi/code/exp/mine/.cache/root/hf/qwen14b_hh_sft_b32/step-160000"
    ...
    with torch.no_grad():
        ...
        for start in dataiter:
            ...
            for idx in range(end - start):
                ...
                # print(responsees[idx])
                # if not examples[start+idx]["sample_res"]:
                # print(json.dumps(responsees))
                # print(generated_ids)
                # continue
